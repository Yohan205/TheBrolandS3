...
execute @a[scores={hello_world2=1}] ~~~ tellraw @s {"rawtext":[{"text":"<§eiKorbon§r> Thanks for downloading the §gMore Simple Structures§f addon by §eiKorbon!§f This add-on was originally uploaded to §2MCPEDL.com, and mcaddons.org.§f Join my §eDiscord§f found on the add-on page. Checkout my §4YouTube§f channel §g@iKorbon!§f §l§cPlease do not redistribute/make your own download links.§eWhen 1.18 fully releases, I will begin to rebuild the addon for the new world generation. You can read my full announcement in my Discord for more info."}]}
